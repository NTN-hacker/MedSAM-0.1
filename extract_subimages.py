...
def main(args):
    ...
    print(f"The time to process is {interval} seconds")
...
def extract_subimages(opt):
    ...
    # scan all images
    img_list = list(os.scandir(input_folder, full_path=True))
...
def worker(path, opt):
    ...
    if ((h > crop_size) and (w > crop_size)):
        ...
        print("The size of image too small")
        pass
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='datasets/sam_data/2024_02_20/HR', help='Input folder')
    parser.add_argument('--output', type=str, default='datasets/sam_data/2024_02_20/samdata_sub_hr', help='Output folder')
    parser.add_argument('--crop_size', type=int, default=200, help='Crop size')
    parser.add_argument('--step', type=int, default=100, help='Step for overlapped sliding window')
    parser.add_argument(
        '--thresh_size',
        type=int,
        default=0,
